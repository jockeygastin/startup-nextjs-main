...
const NewsLatterBox = () => {
  ...
  useEffect(() => {
    if (theme === "dark") {
      setBackgroundImage("url('/images/blog/dark26.jpg");
      setGlassClass('glass1');
      setheading('text-3d');
      setsubheading('text-3d');
    } else {
      setBackgroundImage("url('/images/blog/new14.jpg')");
      setGlassClass('glass');
      setheading('text-3d1');
  ...
  return (
    <div className={`shadow-xl relative z-10 p-8 sm:p-11 lg:p-8 xl:p-11 rounded-xl ${glassClass}`}>
      <h3 className={`mb-4 text-4xl font-bold leading-tight text-black dark:text-white  ${subheading}`}>
      ...
      <div>
        <input
          ...
          className="shadow-xl border-stroke mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none focus:border-primary   dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none  duration-300 hover:border-dark dark:border-transparent dark:bg-[#2C303B] dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary"
        />
        <input
          type="email"
          name="email"
          placeholder="Enter your email"
          className="shadow-xl border-stroke mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none focus:border-primary dark:border-transparent  dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none  duration-300 hover:border-dark dark:bg-[#2C303B] dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary"
        />
 <button type="button" className="btn top-fill1"> <Link href="/">
                Subscribe
              </Link></button>
      </div>
